...
class RGBArrayAsObservationWrapper(dm_env.Environment):
    ...
    def point2action(self, action):
        ...
        # Convert meter / rotvec deltas into controller input scale.
        ...
        if self._normalize_delta_action_to_osc:
            delta_pos_cmd = np.clip(
                delta_pos_cmd / self._controller_output_max_pos,
                -1.0,
                1.0,
            )
            delta_rot_cmd = np.clip(
                delta_rot_cmd / self._controller_output_max_rot,
                -1.0,
                1.0,
            )
