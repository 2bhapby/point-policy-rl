...
class WorkspaceIL:
    def __init__(self, cfg):
        ...
        # load points cfg if using object points
        # try-except since baku doesn't have use_object_points
        try:
...
@hydra.main(config_path="cfgs", config_name="config_parallel_v1", version_base=None)
def main(cfg):
    from train_parallel_v1 import WorkspaceIL as W
